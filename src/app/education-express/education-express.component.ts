...
@Component ({
    selector : 'app-education-express',
    templateUrl : './education-express.component.html',
    styleUrls : ['./education-express.component.less']
})
export class EducationExpressComponent implements OnInit {
